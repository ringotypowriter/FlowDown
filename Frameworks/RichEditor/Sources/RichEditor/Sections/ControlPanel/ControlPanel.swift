...
public class ControlPanel: EditorSectionView {
    ...
    let cameraButton = GiantButton(
        title: NSLocalizedString("Camera", bundle: .module, comment: ""),
        icon: "camera"
    )
    let photoButton = GiantButton(
        title: NSLocalizedString("Photo", bundle: .module, comment: ""),
        icon: "image.up"
    )
    let fileButton = GiantButton(
        title: NSLocalizedString("File", bundle: .module, comment: ""),
        icon: "attachment"
    )
    let webButton = GiantButton(
        title: NSLocalizedString("Web", bundle: .module, comment: ""),
        icon: "link"
    )
    ...
    func toggle() {
        withAnimation { [self] in isPanelOpen.send(!isPanelOpen.value) }
    }
