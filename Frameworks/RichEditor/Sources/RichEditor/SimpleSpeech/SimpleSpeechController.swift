...
public class SimpleSpeechController: AlertBaseController {
    ...
    override public func contentViewDidLoad() {
        ...
        doneButton.setTitle(NSLocalizedString("Preparing Transcript...", bundle: .module, comment: ""), for: .normal)
    ...
    override public func dimmingViewTapped() {
    ...
    override public func contentViewLayout(in bounds: CGRect) {
