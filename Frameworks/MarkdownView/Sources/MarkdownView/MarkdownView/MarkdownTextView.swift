...
public final class MarkdownTextView: UIView {
    ...
    public var ignoresCharacterSetSuffixForCodeHighlighting: CharacterSet? {
        set { viewProvider.ignoresCharacterSetSuffixForCodeHighlighting = newValue }
        get { viewProvider.ignoresCharacterSetSuffixForCodeHighlighting }
    }
